...
// string surname = 2;
inline void Person::clear_surname() {
  _impl_.surname_.ClearToEmpty();
}
inline const std::string& Person::surname() const {
  // @@protoc_insertion_point(field_get:Person.surname)
  return _internal_surname();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Person::set_surname(ArgT0&& arg0, ArgT... args) {
 
 _impl_.surname_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Person.surname)
}
inline std::string* Person::mutable_surname() {
  std::string* _s = _internal_mutable_surname();
  // @@protoc_insertion_point(field_mutable:Person.surname)
  return _s;
}
inline const std::string& Person::_internal_surname() const {
  return _impl_.surname_.Get();
}
inline void Person::_internal_set_surname(const std::string& value) {
  
  _impl_.surname_.Set(value, GetArenaForAllocation());
}
inline std::string* Person::_internal_mutable_surname() {
  
  return _impl_.surname_.Mutable(GetArenaForAllocation());
}
inline std::string* Person::release_surname() {
  // @@protoc_insertion_point(field_release:Person.surname)
  return _impl_.surname_.Release();
}
inline void Person::set_allocated_surname(std::string* surname) {
  if (surname != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Person.surname)
}
